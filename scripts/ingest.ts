 ...
 * from camlawbox.com (Akoma Ntoso HTML).
 *
 * Features:
 ...
 *
 * Data source: camlawbox.com (National Council for Law Reporting)
...
import { parseCambodiaLawHtml, type ActIndexEntry, type ParsedAct } from './lib/parser.js';
...
async function main(): Promise<void> {
  ...
  console.log('====================================================\n');
  console.log(`  Source: camlawbox.com (National Council for Law Reporting)`);
  ...
  for (const law of acts) {
    ...
    try {
      ...
      const parsed = parseCambodiaLawHtml(html, act);
  ...
  console.log(`\n  Source:      camlawbox.com (Akoma Ntoso HTML)`);
