...
export function getAbout(db: InstanceType<typeof Database>, context: AboutContext) {
  ...
  return {
    name: 'Cambodia Law MCP',
    version: context.version,
    jurisdiction: 'KH',
    description: 'Cambodia Law MCP — legislation via Model Context Protocol',
    stats,
    data_sources: [
      {
        name: 'Cambodia Law Library',
        url: 'https://cdc.gov.kh/laws-and-regulations',
        authority: 'Council for the Development of Cambodia',
      },
    ],
    freshness: {
